...
class WP_Widget_Recent_Posts_Custom extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct( 'test-recent-posts', 'Свежие записи кастомные', $widget_ops );
	...
	public function widget( $args, $instance ) {
		...
		<div id="recent-posts-2" class="widget widget_recent_posts">
		    <h4 class="widget_title"><span>		<?php
		if ( $title ) {
		...
		<ul class="recent_posts_list">
			<?php foreach ( $r->posts as $recent_post ) : ?>
				...
				<li>
				   <?php echo get_the_post_thumbnail( $recent_post->ID, 'post-sidebar' ) ?>
				    <div class="post_content">
				        <h6><a href="<?php the_permalink( $recent_post->ID ); ?>"><?php echo $title ; ?></a></h6>
				        <?php if ( $show_date ) : ?>
				        	<p class="date"><?php echo get_the_date( 'j F, Y', $recent_post->ID ); ?></p>
				        <?php endif; ?>
				    </div>
				</li>
